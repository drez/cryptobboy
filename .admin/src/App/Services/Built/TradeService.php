...
class TradeService
{
    ...
    */
    ...
    public function deleteOne()
    {
        ...
        $obj = TradeQuery::create()->findPk(json_decode($this->request['i']));
    ...
    public function saveUpdate()
    {
        ...
        $data['i'] = ( $data['IdTrade'] ) ? $data['IdTrade'] : $this->request['i'];
        $data['ip'] = urldecode($this->request['data']['ip']);
        $data['pc'] = urldecode($this->request['data']['pc']);
        $this->Trade['request'] = $this->request;

        if(!empty($data['i'])) {
            ## Save

            $e = $this->Form->setUpdateDefaultsTrade($data);
            ...
            $e = $this->Form->setCreateDefaultsTrade($data);
    ...
    */
    ...
    {
        $this->Trade['request'] = $this->request;
        $this->Trade['parentId'] = $this->request['data']['ip'];
