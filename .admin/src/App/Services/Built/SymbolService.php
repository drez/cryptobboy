...
class SymbolService
{
    ...
    */
    ...
    public function saveUpdate()
    {
        ...
        $data['i'] = ( $data['IdSymbol'] ) ? $data['IdSymbol'] : $this->request['i'];
        $data['ip'] = urldecode($this->request['data']['ip']);
        $data['pc'] = urldecode($this->request['data']['pc']);
        $this->Symbol['request'] = $this->request;

        if(!empty($data['i'])) {
            ## Save

            $e = $this->Form->setUpdateDefaultsSymbol($data);
            ...
            $e = $this->Form->setCreateDefaultsSymbol($data);
    ...
    */
    ...
    {
        $this->Symbol['request'] = $this->request;
        $this->Symbol['parentId'] = $this->request['data']['ip'];
