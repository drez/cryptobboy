        ...
        if( $pmpoData->isEmpty() ) {
            ...
            **/
            ...
            foreach($pcData as $data) {
                ...
                td(span((($altValue['RightsGroup']) ? $altValue['RightsGroup'] : $data->getRightsGroup()) ?? ''." "), "  i='" . json_encode($data->getPrimaryKey()) . "' c='RightsGroup' class=''  j='editAuthyGroup'") . $cCmoreCols.$actionCell
                , " 
