...
/**
 * Base class that represents a row from the 'authy_group_x' table.
 *
 * Group
 *
 * @package    propel.generator..om
 */
abstract class BaseAuthyGroupX extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'App\\AuthyGroupXPeer';
     ...
     * @return AuthyGroupX The current object (for fluent API support)
     */
    public function setIdAuthy($v)
    {
        ...
        if ($this->id_authy !== $v) {
            $this->id_authy = $v;
            $this->modifiedColumns[] = AuthyGroupXPeer::ID_AUTHY;
        }
    ...
    public function setIdAuthyGroup($v)
    {
        ...
        if ($this->id_authy_group !== $v) {
            ...
            $this->modifiedColumns[] = AuthyGroupXPeer::ID_AUTHY_GROUP;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_authy_group = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = AuthyGroupXPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating AuthyGroupX object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aAuthyGroup !== null && $this->id_authy_group !== $this->aAuthyGroup->getIdAuthyGroup()) {
            $this->aAuthyGroup = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = AuthyGroupXPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = AuthyGroupXQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AuthyGroupXPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AuthyGroupXPeer::ID_AUTHY)) {
            $modifiedColumns[':p' . $index++]  = '`id_authy`';
        }
        if ($this->isColumnModified(AuthyGroupXPeer::ID_AUTHY_GROUP)) {
            $modifiedColumns[':p' . $index++]  = '`id_authy_group`';
        }

        $sql = sprintf(
            'INSERT INTO `authy_group_x` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = AuthyGroupXPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = AuthyGroupXPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['AuthyGroupX'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AuthyGroupX'][serialize($this->getPrimaryKey())] = true;
        $keys = AuthyGroupXPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdAuthy(),
            $keys[1] => $this->getIdAuthyGroup(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setIdAuthyGroup($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AuthyGroupXPeer::ID_AUTHY)) $criteria->add(AuthyGroupXPeer::ID_AUTHY, $this->id_authy);
        if ($this->isColumnModified(AuthyGroupXPeer::ID_AUTHY_GROUP)) $criteria->add(AuthyGroupXPeer::ID_AUTHY_GROUP, $this->id_authy_group);
    ...
    {
        $criteria = new Criteria(AuthyGroupXPeer::DATABASE_NAME);
        $criteria->add(AuthyGroupXPeer::ID_AUTHY, $this->id_authy);
        $criteria->add(AuthyGroupXPeer::ID_AUTHY_GROUP, $this->id_authy_group);
    ...
    {
        $pks = array();
        $pks[0] = $this->getIdAuthy();
        $pks[1] = $this->getIdAuthyGroup();
    ...
    {
        $this->setIdAuthy($keys[0]);
        $this->setIdAuthyGroup($keys[1]);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getIdAuthy()) && (null === $this->getIdAuthyGroup());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of AuthyGroupX (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return AuthyGroupX Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return AuthyGroupXPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new AuthyGroupXPeer();
        }
    ...
    {
        if ($this->aAuthyGroup === null && ($this->id_authy_group !== null) && $doQuery) {
            $this->aAuthyGroup = AuthyGroupQuery::create()->findPk($this->id_authy_group, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyGroup->addAuthyGroupxes($this);
             */
        }
    ...
    public function getAuthy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthy === null && ($this->id_authy !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthy->addAuthyGroupxes($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(AuthyGroupXPeer::DEFAULT_STRING_FORMAT);
    }
