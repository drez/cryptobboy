...
/**
 * Base class that represents a row from the 'template_file' table.
 *
 * File
 *
 * @package    propel.generator..om
 */
abstract class BaseTemplateFile extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'App\\TemplateFilePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        TemplateFilePeer
     */
    ...
    /**
     * The value for the id_template_file field.
     * @var        int
     */
    protected $id_template_file;
    ...
    /**
     * @Field()
     * Get the [id_template_file] column value.
     *
     * @return int
     */
    public function getIdTemplateFile()
    {

        return $this->id_template_file;
    }
    ...
    /**
     * Set the value of [id_template_file] column.
     *
     * @param  int $v new value
     * @return TemplateFile The current object (for fluent API support)
     */
    public function setIdTemplateFile($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->id_template_file !== $v) {
            $this->id_template_file = $v;
            $this->modifiedColumns[] = TemplateFilePeer::ID_TEMPLATE_FILE;
        }
    ...
    public function setIdTemplate($v)
    {
        ...
        if ($this->id_template !== $v) {
            $this->id_template = $v;
            $this->modifiedColumns[] = TemplateFilePeer::ID_TEMPLATE;
        }

        if ($this->aTemplate !== null && $this->aTemplate->getIdTemplate() !== $v) {
            $this->aTemplate = null;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = TemplateFilePeer::NAME;
        }
    ...
    public function setFile($v)
    {
        ...
        if ($this->file !== $v) {
            $this->file = $v;
            $this->modifiedColumns[] = TemplateFilePeer::FILE;
        }
    ...
    public function setDateCreation($v)
    {
        ...
        if ($this->date_creation !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = TemplateFilePeer::DATE_CREATION;
            }
    ...
    public function setDateModification($v)
    {
        ...
        if ($this->date_modification !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = TemplateFilePeer::DATE_MODIFICATION;
            }
        } // if either are not null
    ...
    public function setIdGroupCreation($v)
    {
        ...
        if ($this->id_group_creation !== $v) {
            ...
            $this->modifiedColumns[] = TemplateFilePeer::ID_GROUP_CREATION;
        }
    ...
    public function setIdCreation($v)
    {
        ...
        if ($this->id_creation !== $v) {
            $this->id_creation = $v;
            $this->modifiedColumns[] = TemplateFilePeer::ID_CREATION;
        }
    ...
    public function setIdModification($v)
    {
        ...
        if ($this->id_modification !== $v) {
            ...
            $this->modifiedColumns[] = TemplateFilePeer::ID_MODIFICATION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_template_file = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->id_template = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            ...
            return $startcol + 9; // 9 = TemplateFilePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating TemplateFile object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aTemplate !== null && $this->id_template !== $this->aTemplate->getIdTemplate()) {
            $this->aTemplate = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = TemplateFilePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TemplateFileQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TemplateFilePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TemplateFilePeer::ID_TEMPLATE_FILE)) {
            $modifiedColumns[':p' . $index++]  = '`id_template_file`';
        }
        if ($this->isColumnModified(TemplateFilePeer::ID_TEMPLATE)) {
            $modifiedColumns[':p' . $index++]  = '`id_template`';
        }
        if ($this->isColumnModified(TemplateFilePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(TemplateFilePeer::FILE)) {
            $modifiedColumns[':p' . $index++]  = '`file`';
        }
        if ($this->isColumnModified(TemplateFilePeer::DATE_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_creation`';
        }
        if ($this->isColumnModified(TemplateFilePeer::DATE_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_modification`';
        }
        if ($this->isColumnModified(TemplateFilePeer::ID_GROUP_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_group_creation`';
        }
        if ($this->isColumnModified(TemplateFilePeer::ID_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_creation`';
        }
        if ($this->isColumnModified(TemplateFilePeer::ID_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_modification`';
        }

        $sql = sprintf(
            'INSERT INTO `template_file` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id_template_file`':
                        $stmt->bindValue($identifier, $this->id_template_file, PDO::PARAM_INT);
                        break;
                    case '`id_template`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = TemplateFilePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = TemplateFilePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['TemplateFile'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TemplateFile'][$this->getPrimaryKey()] = true;
        $keys = TemplateFilePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdTemplateFile(),
            $keys[1] => $this->getIdTemplate(),
            $keys[2] => $this->getName(),
            $keys[3] => $this->getFile(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdTemplateFile($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setIdTemplate($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TemplateFilePeer::ID_TEMPLATE_FILE)) $criteria->add(TemplateFilePeer::ID_TEMPLATE_FILE, $this->id_template_file);
        if ($this->isColumnModified(TemplateFilePeer::ID_TEMPLATE)) $criteria->add(TemplateFilePeer::ID_TEMPLATE, $this->id_template);
        if ($this->isColumnModified(TemplateFilePeer::NAME)) $criteria->add(TemplateFilePeer::NAME, $this->name);
        if ($this->isColumnModified(TemplateFilePeer::FILE)) $criteria->add(TemplateFilePeer::FILE, $this->file);
        if ($this->isColumnModified(TemplateFilePeer::DATE_CREATION)) $criteria->add(TemplateFilePeer::DATE_CREATION, $this->date_creation);
        if ($this->isColumnModified(TemplateFilePeer::DATE_MODIFICATION)) $criteria->add(TemplateFilePeer::DATE_MODIFICATION, $this->date_modification);
        if ($this->isColumnModified(TemplateFilePeer::ID_GROUP_CREATION)) $criteria->add(TemplateFilePeer::ID_GROUP_CREATION, $this->id_group_creation);
        if ($this->isColumnModified(TemplateFilePeer::ID_CREATION)) $criteria->add(TemplateFilePeer::ID_CREATION, $this->id_creation);
        if ($this->isColumnModified(TemplateFilePeer::ID_MODIFICATION)) $criteria->add(TemplateFilePeer::ID_MODIFICATION, $this->id_modification);
    ...
    {
        $criteria = new Criteria(TemplateFilePeer::DATABASE_NAME);
        $criteria->add(TemplateFilePeer::ID_TEMPLATE_FILE, $this->id_template_file);
    ...
    {
        return $this->getIdTemplateFile();
    }

    /**
     * Generic method to set the primary key (id_template_file column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdTemplateFile();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of TemplateFile (or compatible) type.
    ...
    {
        $copyObj->setIdTemplate($this->getIdTemplate());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdTemplateFile(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return TemplateFile Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return TemplateFilePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new TemplateFilePeer();
        }
    ...
    {
        if ($v === null) {
            $this->setIdTemplate(NULL);
        } else {
            $this->setIdTemplate($v->getIdTemplate());
        }
    ...
    {
        if ($this->aTemplate === null && ($this->id_template !== null) && $doQuery) {
            $this->aTemplate = TemplateQuery::create()->findPk($this->id_template, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTemplate->addTemplateFiles($this);
             */
        }
    ...
    public function getAuthyGroup(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyGroup === null && ($this->id_group_creation !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyGroup->addTemplateFiles($this);
             */
        }
    ...
    public function setAuthyRelatedByIdCreation(Authy $v = null)
    {
        ...
        if ($v !== null) {
            $v->addTemplateFileRelatedByIdCreation($this);
        }
    ...
    public function getAuthyRelatedByIdCreation(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdCreation === null && ($this->id_creation !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyRelatedByIdCreation->addTemplateFilesRelatedByIdCreation($this);
             */
        }
    ...
    public function setAuthyRelatedByIdModification(Authy $v = null)
    {
        ...
        // If this object has already been added to the Authy object, it will not be re-added.
        if ($v !== null) {
            $v->addTemplateFileRelatedByIdModification($this);
        }
    ...
    public function getAuthyRelatedByIdModification(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdModification === null && ($this->id_modification !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyRelatedByIdModification->addTemplateFilesRelatedByIdModification($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(TemplateFilePeer::DEFAULT_STRING_FORMAT);
    }
