...
abstract class BaseConfig extends BaseObject implements Persistent
{
    ...
    public function getCategory()
    {
        ...
        $valueSet = ConfigPeer::getValueSet(ConfigPeer::CATEGORY);
    ...
    public function setCategory($v)
    {
        ...
        if ($this->category !== $v) {
            $this->category = $v;
            $this->modifiedColumns[] = ConfigPeer::CATEGORY;
        }
    ...
    public function setIdGroupCreation($v)
    {
        ...
        if ($this->id_group_creation !== $v) {
            ...
            $this->modifiedColumns[] = ConfigPeer::ID_GROUP_CREATION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->system = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
            ...
            return $startcol + 12; // 12 = ConfigPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            // GoatCheese behavior
                ...
                $_SESSION[_AUTH_VAR]->config_changed = 'yes';
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ConfigPeer::CATEGORY)) {
        ...
        if ($this->isColumnModified(ConfigPeer::ID_GROUP_CREATION)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setSystem($arr[$keys[4]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ConfigPeer::CATEGORY)) $criteria->add(ConfigPeer::CATEGORY, $this->category);
        ...
        if ($this->isColumnModified(ConfigPeer::ID_GROUP_CREATION)) $criteria->add(ConfigPeer::ID_GROUP_CREATION, $this->id_group_creation);
    ...
    public function getAuthyGroup(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyGroup === null && ($this->id_group_creation !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aAuthyGroup->addConfigs($this);
             */
        }
    ...
    public function setAuthyRelatedByIdCreation(Authy $v = null)
    {
        ...
        if ($v !== null) {
            $v->addConfigRelatedByIdCreation($this);
        }
    ...
    public function getAuthyRelatedByIdCreation(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdCreation === null && ($this->id_creation !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyRelatedByIdCreation->addConfigsRelatedByIdCreation($this);
             */
        }
    ...
    public function setAuthyRelatedByIdModification(Authy $v = null)
    {
        ...
        // If this object has already been added to the Authy object, it will not be re-added.
        if ($v !== null) {
            $v->addConfigRelatedByIdModification($this);
        }
    ...
    public function getAuthyRelatedByIdModification(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdModification === null && ($this->id_modification !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyRelatedByIdModification->addConfigsRelatedByIdModification($this);
             */
        }
